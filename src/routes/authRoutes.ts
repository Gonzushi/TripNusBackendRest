...
export default async function authRoutes(fastify: FastifyInstance) {
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            password: { type: "string", example: "Password123456789!" },
          },
        },
        response: {
          201: {
            ...
            properties: {
              ...
              code: { type: "string", example: "USER_REGISTERED" },
              data: {
                type: "object",
                properties: {
                  user: {
          ...
          400: {
            description:
              "Registration failed due to invalid input or other client error",
            type: "object",
            properties: {
              status: { type: "integer", example: 400 },
              error: { type: "string", example: "User registration failed" },
              message: {
                type: "string",
                example:
                  "Could not register user. Please verify your email and try again.",
              },
              code: { type: "string", example: "SIGN_UP_ERROR" },
              details: {
                type: "string",
          ...
          500: {
            ...
            properties: {
              ...
              code: { type: "string", example: "DB_QUERY_ERROR" },
              details: {
                type: "string",
   ...
   */
  fastify.post("/resend-activation", resendActivation);
   ...
   */
  fastify.post("/reset-password-for-email", resetPasswordForEmail);
